...
const { createSitemap, createSitemapIndex, getRoutes, formatShopRoutes } = require('./builder')
    ...
    nuxtInstance.addServerMiddleware({
      ...
      async handler(req, res, next) {
        try {
          ...
          const shopRoutes = await getRoutes(req)
          const routes = formatShopRoutes(shopRoutes)
...
module.exports = { registerSitemaps, registerSitemap, registerSitemapIndex, getRoutes, formatShopRoutes }
